...
const LoginPage = () => {
  ...
  return (
    <>
      <Stack className="bg-white_A700 font-inter 3xl:h-[1081px] lg:h-[640px] xl:h-[801px] 2xl:h-[901px] mx-[auto] w-[100%]">
        ...
        <Column className="absolute bg-white_A700 h-[max-content] inset-[0] items-center justify-center m-[auto] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[8px] rounded-radius15 w-[35%]">
          <Text className="text-purple_800 w-[auto]" as="h1" variant="h1">
            Login
          </Text>
          <Text
            className="lg:mt-[10px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] not-italic text-purple_800 w-[auto]"
            variant="body1"
          >
          ...
          <Column className="justify-start lg:mb-[17px] xl:mb-[22px] 2xl:mb-[25px] 3xl:mb-[30px] lg:mt-[33px] xl:mt-[41px] 2xl:mt-[47px] 3xl:mt-[56px] w-[89%]">
            <Input
              className="font-medium font-roboto p-[0] lg:text-[13px] xl:text-[16px] 2xl:text-[19px] 3xl:text-[22px] placeholder:text-purple_800 text-purple_800 w-[100%]"
              wrapClassName="w-[100%]"
              type="email"
              name="LoginBox"
            ...
            ></Input>
            <Text
              className="common-pointer font-inter font-normal italic lg:ml-[199px] xl:ml-[249px] 2xl:ml-[280px] 3xl:ml-[336px] lg:mt-[27px] xl:mt-[33px] 2xl:mt-[38px] 3xl:mt-[45px] text-purple_800 w-[auto]"
              as="h5"
              variant="h5"
