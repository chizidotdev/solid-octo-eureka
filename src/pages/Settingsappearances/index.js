...
const SettingsappearancesPage = () => {
  ...
  function handleNavigate27() {
    navigate("/settingsappearancesdark");
  }
              ...
              <Row className="items-center lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] rounded-radius16 w-[100%]">
                <Row className="items-center justify-between w-[88%]">
                  ...
                  <Column className="lg:pr-[3px] xl:pr-[4px] 2xl:pr-[5px] 3xl:pr-[6px] lg:pt-[3px] xl:pt-[4px] 2xl:pt-[5px] 3xl:pt-[6px] w-[87%]">
                    ...
                    <Text
                      className="lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] not-italic text-bluegray_900 w-[auto]"
                      variant="body1"
                    >
                      Set dark mode
                    </Text>
...
export default SettingsappearancesPage;
