...
const SettingsappearancesdarkPage = () => {
      ...
      <Column className="bg-gray_900 font-poppins items-center justify-start mx-[auto] lg:pb-[12px] xl:pb-[16px] 2xl:pb-[18px] 3xl:pb-[21px] w-[100%]">
        <Column className="items-center justify-start w-[100%]">
          ...
          <Row className="font-inter items-start lg:mt-[23px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[39px] w-[94%]">
            ...
            <Column className="justify-start lg:ml-[16px] xl:ml-[20px] 2xl:ml-[23px] 3xl:ml-[27px] lg:mt-[30px] xl:mt-[38px] 2xl:mt-[43px] 3xl:mt-[51px] w-[59%]">
              <Text
                className="lg:ml-[14px] xl:ml-[18px] 2xl:ml-[21px] 3xl:ml-[25px] text-gray_500 w-[auto]"
                as="h4"
                variant="h4"
              >
                Appearances
              ...
              <Row className="items-center lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] rounded-radius16 w-[100%]">
                <Row className="items-center justify-between w-[88%]">
                  ...
                  <Column className="lg:pr-[3px] xl:pr-[4px] 2xl:pr-[5px] 3xl:pr-[6px] lg:pt-[3px] xl:pt-[4px] 2xl:pt-[5px] 3xl:pt-[6px] w-[87%]">
                    <Text
                      className="font-bold text-gray-300 w-[auto]"
                      as="h5"
                      variant="h5"
                    >
                      Dark mode
                    ...
                    <Text
                      className="lg:mt-[13px] xl:mt-[16px] 2xl:mt-[19px] 3xl:mt-[22px] not-italic text-gray-300 w-[auto]"
                      variant="body1"
                    >
                      Set dark mode
                    </Text>
                ...
                <Switch
                  ...
                  value={true}
                  className="common-pointer lg:ml-[25px] xl:ml-[32px] 2xl:ml-[36px] 3xl:ml-[43px] w-[6%]"
                />
              </Row>
              <Input
                className="common-pointer placeholder:text-bluegray_901 Buttonsmall1"
                wrapClassName="2xl:ml-[596px] 2xl:mt-[168px] 3xl:ml-[715px] 3xl:mt-[201px] flex lg:ml-[423px] lg:mt-[119px] w-[23%] xl:ml-[530px] xl:mt-[149px]"
...
export default SettingsappearancesdarkPage;
