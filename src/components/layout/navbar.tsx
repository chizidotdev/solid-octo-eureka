...
export default function Navbar() {
  return (
    <>
      <nav className="fixed bottom-0 z-10 flex h-20 w-full items-center justify-center gap-6 bg-white_day dark:bg-white_night md:sticky md:top-0 md:h-auto md:w-32 md:flex-col md:justify-start md:pt-[20vh] xl:w-[10vw]">
        {icons.map((icon) => (
